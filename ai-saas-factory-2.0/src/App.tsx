...
export default function App() {
  ...
  const handleResetPrompt = async () => {
    if (!confirm("Deseja resetar para o modo ESPECIALISTA EM MIGRAÇÃO (V2)? Este modo corrige erros de sincronismo e atualização de categorias.")) return;
...
AVISO: Se a seleção de categorias não atualizar após criar uma categoria, a migração será considerada FALHA.`;
    ...
    alert("✅ Modo Especialista V2 Ativado! Agora as categorias e produtos sincronizarão corretamente. Salve e gere novamente.");
  };
